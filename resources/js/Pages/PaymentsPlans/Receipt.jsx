        ...
        <>
            ...
            <div ref={printRef} className="max-w-3xl mx-auto p-6 text-sm font-sans text-slate-700  border-slate-300 rounded-lg mt-10 bg-slate-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 border border-slate-200 rounded-lg p-4 bg-slate-50">
                    <div>
                        <p className="mb-2">
                            <span className="font-semibold text-slate-600">Cliente:</span> {`${client.name} ${client.lastname}`}
                        </p>
                        <p className="mb-2">
                            <span className="font-semibold text-slate-600">Género:</span> {client.gender.name ?? 'Género N/D'}
                        </p>
                        <p className="mb-2">
                            <span className="font-semibold text-slate-600">Código:</span> {client.code}
                        </p>
                    </div>
                    <div>
                        <p className="mb-2">
                            <span className="font-semibold text-slate-600">Celular:</span> {client.cellphone ?? 'N/D'}
                        </p>
                        <p className="mb-2">
                            <span className="font-semibold text-slate-600">Fecha de inscripción:</span> {client.inscription_day ?? 'N/D'}
                        </p>
                    </div>
                </div>
                <div className="border border-slate-200 rounded-lg p-4 bg-slate-50 mb-6">
                    ...
                    <p className="mb-2">
                        <span className="font-semibold text-slate-600">Fecha de Inicio:</span> {payment.start_date}
                    </p>
                    <p className="mb-2">
                        <span className="font-semibold text-slate-600">Fecha de Vencimiento:</span> {payment.end_date}
                    </p>
                </div>
                ...
                <div className="flex justify-between mt-10 mb-6">
                    <div className="text-center">
                        ...
                        <p className="text-slate-600 text-xs">Firma del Cliente</p>
                    </div>
                    <div className="text-center">
                        <div className="border-t border-slate-400 w-48 mx-auto mb-1"></div>
            ...
            <div className="print:hidden max-w-4xl mx-auto p-4 flex justify-center items-center space-x-4">
                ...
                <button
                    type="button"
                    onClick={() => router.visit(`/payments_plans/${client.id}`)}
